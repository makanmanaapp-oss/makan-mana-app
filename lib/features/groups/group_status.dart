      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _field(l.t('favCuisineLabel'), _cuisine, l.t('statusCuisineHint')),
            _field(l.t('allergyWarning'), _allergy, l.t('statusAllergyHint')),
            ...
            if (_shareFitness)
              _field(l.t('fitnessGoalLabel'), _fitness, l.t('statusFitnessHint')),
            const SizedBox(height: 14),
            SizedBox(
